...
import profile from "../images/users/avatar-1.jpg"
                ...
                <div className="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    ...
                    <div>
                        ...
                        <div className="text-center p-4 border-bottom">
                            <div className="mb-4">
                                <img src={profile} className="rounded-circle avatar-lg img-thumbnail" alt />
                            </div>
                            <h5 className="font-size-16 mb-1 text-truncate">Patricia Smith</h5>
                            <p className="text-muted text-truncate mb-1"><i className="ri-record-circle-fill font-size-10 text-success me-1 ms-0 d-inline-block" />
                                Active</p>
                        </div>
                        {/* End profile user */}
                        ...
                        <div className="p-4 user-profile-desc" data-simplebar>
                            <div className="text-muted">
                                <p className="mb-4">If several languages coalesce, the grammar of the resulting language is
