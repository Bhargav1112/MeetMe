                                ...
                                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div className="modal-content">
                                        <div className="modal-header">
                                            <h5 className="modal-title font-size-16" id="addgroup-exampleModalLabel">Create
                                                New Group</h5>
                                        ...
                                        <div className="modal-body p-4">
                                            <form>
                                                <div className="mb-4">
                                                    <label htmlFor="addgroupname-input" className="form-label">Group
                                                        Name</label>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    <input type="checkbox" className="form-check-input" id="memberCheck1" defaultChecked />
                                                                                    <label className="form-check-label" htmlFor="memberCheck1">Albert
                                                                                        Rodarte</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck2">Allison
                                                                                        Etter</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck3">Craig
                                                                                        Smiley</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck4">Daniel
                                                                                        Clay</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck5">Iris
                                                                                        Wells</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck6">Juan
                                                                                        Flakes</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck7">John
                                                                                        Hall</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck8">Joy
                                                                                        Southern</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck9">Michael
                                                                                        Hinton</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck10">Mary
                                                                                        Farmer</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck11">Phillis
                                                                                        Griffin</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck12">Rocky
                                                                                        Jackson</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul className="list-unstyled contact-list">
                                                                            <li>
                                                                                <div className="form-check">
                                                                                    ...
                                                                                    <label className="form-check-label" htmlFor="memberCheck13">Simon
                                                                                        Velez</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <textarea className="form-control" id="addgroupdescription-input" rows={3} placeholder="Enter Description" defaultValue={""} />
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 overflow-hidden">
                                                <h5 className="text-truncate font-size-14 mb-0">#Reporting <span className="badge badge-soft-danger rounded-pill float-end">+23</span>
                                                </h5>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 overflow-hidden">
                                                <h5 className="text-truncate font-size-14 mb-0">#Developers <span className="badge badge-soft-danger rounded-pill float-end">New</span>
                                                </h5>
                                            </div>
                                        </div>
                                    </a>
